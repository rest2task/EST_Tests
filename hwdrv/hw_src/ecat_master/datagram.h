...
Description:   EtherCAT datagram definition
...
/******************************************************************************
 *
 *  $Id: datagram.h,v 1.1 2015/02/06 05:23:04 kidd Exp $
 *
...
typedef struct {
	...
	uint8_t blk[3];			/*gonggw, 2013.09.29, for the flowing data to be word aligned*/
