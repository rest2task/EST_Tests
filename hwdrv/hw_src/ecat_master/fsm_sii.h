...
Description:  SII access definition
...
/******************************************************************************
 *
 *  $Id: fsm_sii.h,v 1.2 2015/02/13 08:04:01 kidd Exp $
 *
...
struct ec_fsm_sii
{
    ...
    //gonggw, 2014.03.17, SII request length, 4 or 8
	uint8_t length;
    
    uint16_t value[4]; /**< raw SII value (32bit) */
