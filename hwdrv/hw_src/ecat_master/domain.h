...
Description:  domain accesws definition
...
/******************************************************************************
 *
 *  $Id: domain.h,v 1.1 2015/02/06 05:23:04 kidd Exp $
 *
...
struct ec_domain
{
    ...
    uint32_t            logical_base_address;       /**< Logical offset address of the process data. */
    ...
    unsigned int        working_counter_changes;    /**< Working counter changes since last notification. */
