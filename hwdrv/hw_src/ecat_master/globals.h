...
Description:  Global parameter definition of EtherCAT Master
...
/******************************************************************************
 *
 *  $Id: globals.h,v 1.2 2015/02/13 08:04:01 kidd Exp $
 *
...
#if 0 //gonggw, 2014.07.03,original code
#define EC_MAX_FMMUS 16
#else //8 FMMU entries in ET1100
#define EC_MAX_FMMUS 8
#endif
 ...
 **/
#define EC_DATAGRAM_NAME_SIZE 4
...
#define EC_ERR(fmt, args...) \
    uart_printf("EtherCAT ERROR: " fmt, ##args)
#else
#define EC_ERR(fmt, args...)
#endif
...
#define EC_WARN(fmt, args...) \
	if(EC_DEBUG_LEVEL > 0)	\
	    uart_printf("EtherCAT WARNING: " fmt, ##args)
#else
#define EC_WARN(fmt, args...)
#endif
...
#define EC_DBG(fmt, args...) \
	if(EC_DEBUG_LEVEL > 2) \
	    uart_printf("EtherCAT DEBUG: " fmt, ##args)
