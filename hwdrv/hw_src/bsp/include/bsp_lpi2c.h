...
#define SCL_IOMUXC       IOMUXC_GPIO_SD_B1_04_LPI2C1_SCL
#define SDA_IOMUXC       IOMUXC_GPIO_SD_B1_05_LPI2C1_SDA

//#define SCL_IOMUXC       IOMUXC_GPIO_SD_B1_04_GPIO3_IO04
//#define SDA_IOMUXC       IOMUXC_GPIO_SD_B1_05_GPIO3_IO05
...
extern uint32_t Sensor_write_hardware(uint8_t reg_add,uint8_t reg_dat,uint8_t intorno);
extern uint32_t Sensor_Read_hardware(uint8_t reg_add,unsigned char* Read,uint8_t num);
																					
void I2C_LM73_Init(void);
void I2C_IOMUXC_MUX_Config(void);
void I2C_IOMUXC_PAD_Config(void);										  
