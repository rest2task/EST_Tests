...
static void MoldRead()
{
    ...
    PanelRecAdd(mold_set_pg.button8, PNL_READ, 0);
}
...
static int Mold_SetOnInit(Mold_Set_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
    return 0;
}
static int Mold_SetOnShow(Mold_Set_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
...
static int Mold_SetOnHide(Mold_Set_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
    SetPageLockMode(MODE_NOLOCK);//20210914 dyl touch
    return 0;
}
static int Mold_SetOnUpdate(Mold_Set_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
    PWGT focus_wgt;
    UI32 goff;
...
static int Mold_SetOnChange(Mold_Set_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
	UI32 addr, goff; 
	PATTR pattr;
