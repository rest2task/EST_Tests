...
DEFINE_IO_OUTPUTX_MAP

CONNECT_IO_OUTPUTX_EVENT
...
static int IO_OutputxOnInit(IO_Outputx_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
    SetIOOutZeroCB(Outputx_ForceZero);
    return 0;
}
static int IO_OutputxOnShow(IO_Outputx_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
...
static int IO_OutputxOnHide(IO_Outputx_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
...
static int IO_OutputxOnUpdate(IO_Outputx_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
...
static int IO_OutputxOnChange(IO_Outputx_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
