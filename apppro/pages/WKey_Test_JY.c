...
DEFINE_KEY_TEST_JY_MAP

CONNECT_KEY_TEST_JY_EVENT

static void CtlConnect()
{
}
static int Key_Test_JYOnInit(Key_Test_JY_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
    SetTestKeyCB(TestKey);
    InitKeyHash();
    return 0;
}
static int Key_Test_JYOnShow(Key_Test_JY_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
    KeyTestShowInit();
...
static int Key_Test_JYOnHide(Key_Test_JY_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
    KeyTestCloseInit();
    return 0;
}
static int Key_Test_JYOnUpdate(Key_Test_JY_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
    return 0;
}
static int Key_Test_JYOnChange(Key_Test_JY_PG* ppg, PWGT pwgt, MSG_ID msg_id, int msg_value, int msg_para)
{
